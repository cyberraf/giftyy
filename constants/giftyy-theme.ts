...
export const GIFTYY_THEME = {
	...
	colors: {
		...
		discount: '#ef4444',
		newBadge: '#22c55e',
		saleBadge: '#14b8a6', // Teal for sale badge
		featured: '#fbbf24',
	...
	// Gradients
	gradients: {
		primary: ['#2d3748', '#4a5568'], // Dark grey gradient
		accent: ['#14b8a6', '#2dd4bf'], // Teal gradient for CTAs
		warm: ['#f0fdfa', '#ccfbf1'], // Subtle teal tint
		celebration: ['#14b8a6', '#2dd4bf', '#5eead4'], // Teal celebration
	},
} as const;
