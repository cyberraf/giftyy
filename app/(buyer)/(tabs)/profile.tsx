        ...
        return (
            <View style={styles.sectionCard}>
                <View style={styles.emptyWishlistState}>
                    ...
                    <Pressable style={styles.secondaryButton} onPress={() => router.push('/(buyer)/(tabs)/shop')}>
    ...
    return (
        <View style={styles.wishlistSection}>
            <View style={styles.wishlistHeaderRow}>
                ...
                <Pressable style={styles.wishlistExploreButton} onPress={() => router.push('/(buyer)/(tabs)/shop')}>
