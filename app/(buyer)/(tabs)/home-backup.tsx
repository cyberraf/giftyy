...
import { ActivityIndicator, Dimensions, FlatList, Image, Modal, Pressable, RefreshControl, ScrollView, StyleSheet, Text, TextInput, View } from 'react-native';
	...
	return (
		<View style={{ flex: 1, backgroundColor: '#fff' }}>
			...
			<FlatList
				...
				renderItem={({ item }) => {
					// Calculate card width for 3 columns: (screen width - padding(32) - gaps(20)) / 3
					const cardWidth = (SCREEN_WIDTH - 52) / 3;
					return (
